odoo.define('mindala.s_blog_posts_options', function (require) {
'use strict';
...
const dynamicSnippetBlogPostsOptions = dynamicSnippetOptions.extend({
    ...
    init: function () {
        ...
        this.modelNameFilter = 'blog.m4pnews';
        this.blogs = {};
    },
    /**
     * @override
    ...
    _computeWidgetVisibility: function (widgetName, params) {
        if (widgetName === 'hover_effect_opt') {
            return this.$target.get(0).dataset.templateKey === 'mindala.dynamic_filter_template_blog_post_big_picture';
        }
